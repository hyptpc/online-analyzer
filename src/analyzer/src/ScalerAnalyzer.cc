...
ScalerAnalyzer::Decode( void )
{
  ...
  //////////////////// Trigger Flag
  {
    static const Int_t SpillEndFlag = 1;
    static const Int_t device_id = gUnpacker.get_device_id("TriggerFlag");
    static const Int_t tdc_id    = gUnpacker.get_data_id("TriggerFlag", "leading");
  ...
  //////////////////// Scaler Data
  {
	...
	//	std::cout<<i<<"  "<<j<<"  "<<module_id<<"  "<<channel<<"  "<<val<<std::endl;
