...
my_obj_jsroot	:= $(core_obj) user_jsroot.o
my_tgt_jsroot	:= $(bin_dir)/jsroot
...
#
#______________________________________________________________________________
my_obj_jsroot	:= $(addprefix $(my_dir)/src/,$(my_obj_jsroot))
my_obj_jsroot	:= $(my_obj_jsroot)
my_lib_jsroot	:= libmyjsroot.so
$(eval $(call make-lib,$(my_lib_jsroot),$(my_obj_jsroot)))
$(eval $(call make-nogui-target,$(my_tgt_jsroot),$(my_lib_jsroot)))
#
#______________________________________________________________________________
